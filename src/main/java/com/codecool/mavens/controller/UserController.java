...
public class UserController {
    ...
    @GetMapping("/trial/{id}")
    public User getUserByIdTrial(@PathVariable Long id) {
        return userService.getUserByID(id);
        ...
        /*return "{\"id\":7," +
                ...
                "\"locations\":[{" +
                "\"id\":13," +
                "\"name\":\"Budapest\"},{\"id\":88,\"name\":\"Dubai\"}]},\"registrationTime\":\"2022-01-13T10:42:49.685216\",\"lastLoginTime\":\"2022-01-17T10:42:49.685216\"}";    }
*/
    }
    @PostMapping("/new")
